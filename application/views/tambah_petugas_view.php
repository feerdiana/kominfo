...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <?php echo form_open('Petugas/create/'.$idPegawai); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nama_petugas" placeholder="Input field">
            <label for="">NIP</label>
        <input type="number" placeholder="Input field" name="nip" class="form-control" />
